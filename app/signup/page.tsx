...
export default function Signup({ searchParams }: { searchParams: { message: string } }) {
    ...
    return (
        <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2">
            <div className="bg-gray-400 rounded-lg w-full p-20">
                <form
                ...
                >
                    ...
                    <div className="relative mb-6">
                        <input
                            className="rounded-md px-4 py-2 bg-inherit border w-full text-black"
                    ...
                    <label className="text-md text-black" htmlFor="confirmPassword">
                        Confirm Password
                    </label>
                    <div className="relative mb-6">
                        <input
