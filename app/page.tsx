        ...
        <div className="max-w-4xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <section className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-md mb-4">- <strong>Targeted for Success</strong>: Perfect for anyone who requires comprehensive background information for meetings and pitches.</p>
              <p className="text-md mb-6">- <strong>Comprehensive Data </strong>: Gather data from sources like LinkedIn, Facebook, and news articles and recieve everything you need to prepare for your meeting.</p>
            ...
            <section className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-md mb-4">- <strong>Seamless Integration</strong>: Export results in PDF format and plan for future API integrations with CRM systems like Salesforce or HubSpot as well as an Enterprise level open API.</p>
              <p className="text-md mb-4">- <strong>Customizable Insights</strong>: Tailor reports and use the power of prept chat to write custom insights, emails, tailored questions and more!</p>
